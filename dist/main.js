...
/* harmony export */ });
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utility */ "./src/Model/utility.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getInsertableID": () => (/* binding */ getInsertableID)
/* harmony export */ });
...
function toggleTodoDateEdit(todoID) {
  const todo = mainPortfolio.getActiveProject().getTodoByID(todoID);
  const inputNode = (0,_View_viewModule__WEBPACK_IMPORTED_MODULE_4__.createTodoDateEditor)(todo.getTitle(), updateTodoDate);
...
const initialisePage = (portfolio) => {
  ...
  const sidebar = (0,_View_viewModule__WEBPACK_IMPORTED_MODULE_4__.createSidebar)(projects, activateProject);
