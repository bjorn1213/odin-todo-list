...
const mainPortfolio = (0,_Controller_dataHandler__WEBPACK_IMPORTED_MODULE_3__.getDummyPortfolio)();
...
function updateTodoDate(todoID, newDate) {
  const todo = mainPortfolio.getActiveProject().getTodoByID(todoID);
  const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(newDate, "yyyy-mm-dd", new Date());
